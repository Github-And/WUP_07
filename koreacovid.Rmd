...
## Conclusions
In summary, males died more to COVID-19 than females in Korea. Although the data shows only a small amount of people died to the disease, it was males that died the most than compared to females. The inferential data shows that the total amount of females that caught the disease are 1817, which is more than males by 392.So it's surprising that even with a bigger pool of females, males are the one that died the most.
